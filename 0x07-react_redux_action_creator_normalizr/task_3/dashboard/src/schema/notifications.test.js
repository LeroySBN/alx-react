...
describe('Tests for notifications schema', () => {
  it('verifies that when calling getAllNotificationsByUser with known userId, the correct array of notifications is returned', () => {
...
test('normalized data has a correct result array', () => {
  ...
  expect(resultArray).toEqual(expectedIds);
});
...
test('normalized data has a correct users entity', () => {
  ...
  expect(usersEntity[userId]).toEqual(expectedUser);
});
...
test('normalized data has a correct messages entity', () => {
  ...
  expect(messagesEntity[messageGuid]).toEqual(expectedMessage);
});
...
test('normalized data has a correct notifications entity', () => {
  ...
  expect(notificationsEntity[notificationId]).toEqual(expectedNotification);
});
