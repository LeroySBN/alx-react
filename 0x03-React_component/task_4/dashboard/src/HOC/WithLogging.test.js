...
describe('WithLogging HOC', () => {
  it('should log mount and unmount for pure HTML component', () => {
    ...
    expect(spyConsoleLog).toHaveBeenCalledWith('Component Component is mounted');

    wrapper.unmount();
    expect(spyConsoleLog).toHaveBeenCalledWith('Component Component is going to unmount');
